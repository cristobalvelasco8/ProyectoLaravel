...
class ClientController extends Controller
{
    ...
    {
        $usuarios = Client::all();
        return view('veterinario')->with('usuarios', $usuarios);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return view('registroAnimal')->with('clienteId',$newClient->id)->with('nuevoCliente',$newClient->nombre ." ". $newClient->apellidos);
        } catch (QueryException $exception) {
            //return $exception->errorInfo;
            return redirect()->route('registrarAnimal')->with('errorCliente', 1);
        }
    }

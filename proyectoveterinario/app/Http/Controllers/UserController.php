...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('registrarVeterinarios')->with('error', 1);
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('modificarVeterinarios')->with('veterinario', $veterinario);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return view('veterinarios')->with('veterinarioNombre', $user->nombre)->with('veterinarioApellidos', $user->apellidos);
        } catch (QueryException $exception) {
            return $exception->errorInfo;
    ...
    public function destroy($id)
    {
        ...
        return view('veterinarios')->with('deletedNombre', $usuario->nombre)->with('deletedApellidos', $usuario->apellidos);
    }
}
